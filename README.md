# 🎓 Sistem Penerimaan Murid Baru (SPMB) Az-Zahra

Aplikasi Sistem Penerimaan Murid Baru (SPMB) berbasis website yang dirancang khusus untuk mengelola proses pendaftaran, seleksi, dan administrasi murid baru di lembaga pendidikan PAUD Az-Zahra Depok.
...
2. Masuk ke direktori proyek: `cd <direktori-proyek>`
