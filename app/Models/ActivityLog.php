...
class ActivityLog extends Model
{
    ...
    public function getActionLabelAttribute(): string
    {
        return match ($this->action) {
            ...
            'student_officially_enrolled' => 'Siswa Resmi Terdaftar',
            'enrollment_discontinued' => 'Pendaftaran Ditutup',
            'accepted' => 'Menerima',
            'rejected' => 'Menolak',
    ...
    public function getActionColorAttribute(): string
    {
        return match ($this->action) {
            ...
            'payment_verified', 'student_officially_enrolled' => 'bg-emerald-100 text-emerald-700 border border-emerald-200 dark:bg-emerald-500/15 dark:text-emerald-300 dark:border-emerald-400/20',
            'payment_rejected', 'enrollment_discontinued' => 'bg-red-100 text-red-700 border border-red-200 dark:bg-red-500/15 dark:text-red-300 dark:border-red-400/20',
