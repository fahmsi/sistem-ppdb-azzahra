    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(isset($testimonials) && $testimonials->count() > 0)
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 fade-up">
                <div class="flex items-center gap-3 bg-white border border-gray-200 rounded-2xl px-6 py-3 shadow-sm">
        ...
        {{-- Reviews Grid (horizontal auto-scroll) --}}
        @if(isset($testimonials) && $testimonials->count() > 0)
            @php
            ...
            <div class="relative w-full mt-14">
                <div class="relative mx-auto max-w-7xl">
                    <div class="testimonial-mask mt-10 overflow-hidden">
                        <div class="testimonial-row">
                            <div class="testimonial-row-inner">
                                @foreach($testimonials as $testimonial)
                                    <article class="group min-w-[320px] lg:min-w-[360px] flex-shrink-0">
                                        <div class="bg-white rounded-2xl shadow-md border border-gray-200 hover:border-primary-200 hover:shadow-lg transition-all duration-300 p-6 h-full flex flex-col">
                                            <div class="flex items-start gap-4 mb-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <p class="font-heading font-bold text-gray-900 truncate">{{ $testimonial->name }}</p>
                                                    <p class="text-xs text-gray-400 mt-0.5">{{ $testimonial->created_at->diffForHumans() }}</p>
                                                </div>

                                                <div class="flex-shrink-0 opacity-60 group-hover:opacity-100 transition-opacity">
