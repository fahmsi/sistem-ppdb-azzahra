...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <nav class="text-sm text-[#a1b0cb] dark:text-[#7e8ba1] font-medium tracking-wide mb-6">
        Dashboard <span class="mx-1">&gt;</span> Admin <span class="mx-1">&gt;</span> <span class="text-[#697a8d] dark:text-[#b4bdc6] font-semibold">Data Induk Siswa</span>
    </nav>
        ...
        debounceTimer = setTimeout(function() {
            ...
            .then(function(data) {
                ...
                data.forEach(function(s, i) {
                    html += '<tr class="border-b border-[#d9dee3] dark:border-[#434463] hover:bg-[#f5f5f9]/50 dark:hover:bg-[#232333]/50">';
                    ...
                    html += '<td class="px-5 py-3.5 text-[#697a8d] dark:text-[#a1b0cb]">' + s.jenis_kelamin + '</td>';
                    html += '<td class="px-5 py-3.5 text-[#697a8d] dark:text-[#a1b0cb]">' + s.orang_tua + '</td>';
