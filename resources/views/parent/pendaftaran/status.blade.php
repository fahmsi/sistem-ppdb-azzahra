                                ...
                                <div class="text-left sm:text-right">
                                    ...
                                    @elseif($reg->status === 'ditolak')
                                        <span class="inline-flex items-center gap-1.5 rounded-full border border-red-200 bg-red-100 px-3 py-1.5 text-sm font-semibold text-red-700 dark:border-red-500/25 dark:bg-red-500/15 dark:text-red-300">
                                            <i data-lucide="x-circle" class="w-4 h-4"></i> Pendaftaran Ditolak
                                        </span>
                                    ...
                                    <div class="mt-6 rounded-xl border border-secondary-200 bg-secondary-50 p-4 dark:border-secondary-500/20 dark:bg-secondary-500/10 sm:p-5">
                                        @if(!$payment)
                                            <h5 class="mb-3 flex items-center gap-2 text-base font-bold text-secondary-800 dark:text-secondary-300">
                                                ...
                                                Berkas Terverifikasi – Lanjut Observasi
                                            </h5>
                                            ...
                                            <p class="mb-4 text-xs text-amber-700 dark:text-amber-400 bg-amber-500/10 p-2.5 rounded-lg border border-amber-500/20">
                                            ...
                                            @if($paymentSetting)
                                                <p class="mt-4 text-sm text-gray-700 dark:text-[#d5d5e2]">Setelah mengikuti observasi dan mendapat arahan sekolah, silakan lakukan pembayaran daftar ulang dan unggah bukti pembayaran melalui tombol di bawah ini.</p>
                                            @endif
                                        @elseif($isPaymentWaiting)
                                ...
                                @if($payment)
                                    <div class="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-[#434463] dark:bg-[#232333]">
                                        ...
                                        <div class="flex flex-wrap items-center gap-3 mb-2">
                                            @if($isPaymentLunas)
                                                <span class="rounded-full bg-secondary-100 px-2.5 py-1 text-xs font-semibold text-secondary-800 dark:bg-secondary-500/15 dark:text-secondary-300">Lunas / Diverifikasi</span>
                                            @elseif($isPaymentRejected)
                                ...
                                <div class="fixed inset-0 z-10 overflow-y-auto">
                                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 pointer-events-none">
                                        <div class="pointer-events-auto relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all dark:bg-[#2b2c40] sm:my-8 sm:w-full sm:max-w-md">
                                            ...
                                            <form action="{{ route('parent.pembayaran.store', $reg->id) }}" method="POST" enctype="multipart/form-data" data-parent-upload-form>
                                                @csrf
                                                <div class="space-y-5 px-4 py-5 sm:px-6 sm:py-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" name="bukti_bayar" accept="image/jpeg,image/png,image/jpg,application/pdf" required
                                                            data-file-input data-file-field data-file-max-size="2097152" data-file-error="bukti-bayar-size-error-{{ $reg->id }}"
                                                            class="block w-full rounded-lg border border-gray-300 text-sm text-gray-500 file:mr-3 file:border-0 file:bg-primary-50 file:px-3 file:py-2 file:text-sm file:font-semibold file:text-primary-700 hover:file:bg-primary-100 dark:border-[#434463] dark:bg-[#232333] dark:text-[#a1b0cb] sm:file:mr-4 sm:file:px-4">
                                                        <p class="mt-1 text-xs text-gray-500 dark:text-[#a1b0cb]">Format JPG, PNG, atau PDF max 2MB.</p>
                                                        <p id="bukti-bayar-size-error-{{ $reg->id }}" class="mt-1 hidden text-sm text-red-600 dark:text-red-400" role="alert"></p>
                                                        @error('bukti_bayar') <p class="mt-1 text-sm text-red-500">{{ $message }}</p> @enderror
                                                    </div>
                                                </div>
