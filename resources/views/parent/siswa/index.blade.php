...
<div class="w-full space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="font-heading text-2xl font-bold text-[#566a7f] dark:text-[#d5d5e2]">Data Anak</h2>
            <p class="mt-1 text-sm text-[#a1b0cb]">Kelola data anak dan lanjutkan pendaftaran.</p>
        </div>
