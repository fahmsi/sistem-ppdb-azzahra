            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nisn" value="{{ old('nisn', $siswa->nisn) }}" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">NIS (Jika Ada)</label>
                        <input type="text" name="nis" value="{{ old('nis', $siswa->nis) }}" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenis_tempat_tinggal" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('jenis_tempat_tinggal') border-red-500 @enderror">
                            <option value="">-- Pilih --</option>
                            <option value="Bersama Orang Tua" {{ old('jenis_tempat_tinggal', $siswa->jenis_tempat_tinggal) == 'Bersama Orang Tua' ? 'selected' : '' }}>Bersama Orang Tua</option>
                            <option value="Asrama" {{ old('jenis_tempat_tinggal', $siswa->jenis_tempat_tinggal) == 'Asrama' ? 'selected' : '' }}>Asrama</option>
                            <option value="Lainnya" {{ old('jenis_tempat_tinggal', $siswa->jenis_tempat_tinggal) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div class="space-y-5 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div>
                            ...
                            <select name="pendidikan_ayah" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('pendidikan_ayah') border-red-500 @enderror">
                                ...
                                <option value="D3/S1/S2" {{ old('pendidikan_ayah', $siswa->pendidikan_ayah) == 'D3/S1/S2' ? 'selected' : '' }}>D3/S1/S2</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah', $siswa->pekerjaan_ayah) }}" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('pekerjaan_ayah') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select name="penghasilan_ayah" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('penghasilan_ayah') border-red-500 @enderror">
                                <option value="">-- Pilih --</option>
                                <option value="< 1 Juta" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah) == '< 1 Juta' ? 'selected' : '' }}>Kurang dari 1 Juta</option>
                                <option value="1-3 Juta" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah) == '1-3 Juta' ? 'selected' : '' }}>1 Juta - 3 Juta</option>
                                <option value="> 3 Juta" {{ old('penghasilan_ayah', $siswa->penghasilan_ayah) == '> 3 Juta' ? 'selected' : '' }}>Lebih dari 3 Juta</option>
                            </select>
                    ...
                    <div class="space-y-5 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div>
                            ...
                            <select name="pendidikan_ibu" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('pendidikan_ibu') border-red-500 @enderror">
                                ...
                                <option value="D3/S1/S2" {{ old('pendidikan_ibu', $siswa->pendidikan_ibu) == 'D3/S1/S2' ? 'selected' : '' }}>D3/S1/S2</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu', $siswa->pekerjaan_ibu) }}" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('pekerjaan_ibu') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select name="penghasilan_ibu" class="w-full rounded-lg border-gray-300 focus:ring-primary-500 focus:border-primary-500 @error('penghasilan_ibu') border-red-500 @enderror">
                                <option value="">-- Pilih --</option>
                                <option value="< 1 Juta" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu) == '< 1 Juta' ? 'selected' : '' }}>Kurang dari 1 Juta</option>
                                <option value="1-3 Juta" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu) == '1-3 Juta' ? 'selected' : '' }}>1 Juta - 3 Juta</option>
                                <option value="> 3 Juta" {{ old('penghasilan_ibu', $siswa->penghasilan_ibu) == '> 3 Juta' ? 'selected' : '' }}>Lebih dari 3 Juta</option>
                            </select>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        kecSelect.addEventListener('change', function(){ var s=kecSelect.options[kecSelect.selectedIndex]; kecHidden.value=s.textContent!=='-- Pilih --'?s.textContent:''; if(this.value) fetchOptions(API_BASE+'/villages/'+this.value+'.json',kelSelect,kelHidden,[]); });
