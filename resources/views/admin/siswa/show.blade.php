            ...
            <div class="flex flex-col sm:flex-row gap-6 items-start -mt-16 mb-8 relative z-10">
                ...
                <div class="pt-16 sm:pt-18 flex-1 w-full">
                    ...
                    <div class="flex flex-wrap gap-4 mt-2 text-sm text-gray-600">
                        <span class="flex items-center gap-1.5"><i data-lucide="calendar" class="w-4 h-4 text-primary-500"></i> Laki-laki</span> <!-- Can use logic here -->
                        <span class="flex items-center gap-1.5"><i data-lucide="map-pin" class="w-4 h-4 text-primary-500"></i> {{ $siswa->kota }}</span>
                        @if($siswa->nisn)
                            <span class="flex items-center gap-1.5"><i data-lucide="hash" class="w-4 h-4 text-primary-500"></i> NISN: {{ $siswa->nisn }}</span>
                        @endif
                    </div>
                </div>
            </div>
